...
import { Activity, Bell, FileText, Mail, Plus, Search, Users, DollarSign, TrendingUp, CreditCard, Briefcase } from "lucide-react"
    ...
    <div className="m-4 p-6 rounded-lg bg-blue-50 flex flex-col md:flex-row justify-between items-center">
      <div className="md:w-2/3">
        ...
        <p className="text-slate-600 text-sm">
          ...
          Bertanggung jawab untuk perencanaan anggaran, perkiraan keuangan, dan manajemen pengeluaran.
          Dikenal karena efisiensi proses keuangan dan peningkatan kualitas pelaporan.
        </p>
      ...
      <div className="md:w-1/3 flex justify-center mt-4 md:mt-0">
        <img src="https://img.freepik.com/free-photo/business-graphics-presentation-illustration_23-2151876392.jpg?t=st=1746555381~exp=1746558981~hmac=a61a687f49c9cc559c1e64e6de86e29a5b7d766ddeb2282720333e25462beab1&w=1380" alt="Ilustrasi Keuangan" className="h-32" />
      </div>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 m-4">
      ...
      <div className="bg-white rounded-lg border border-slate-200 p-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <Button variant="link" className="text-xs text-blue-600">Lihat Semua</Button>
        </div>
